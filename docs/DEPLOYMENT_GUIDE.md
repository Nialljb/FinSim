...
This happens when your code has new database columns that don't exist in the production database yet.

**Quick Fix via Render Shell:**
1. Go to Render Dashboard → Your Web Service
2. Click "Shell" in the left sidebar
3. Run: `python fix_render_db.py`
4. Restart the service

**Alternative - Run Migration Script:**
1. SSH into Render or use Shell
2. Run: `python migrations/sync_schema.py`
3. This will show you all missing columns and add them

**Why does this happen?**
- SQLAlchemy models (code) update when you deploy
- Database schema doesn't auto-update
- You need to manually run migrations to add new columns

See `migrations/README.md` for more details on database migrations.
